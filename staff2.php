...
<input type = 'text' name = 'id' placeholder = 'Staff id' class = 'form-control' required title = 'STAFF ID' autocomplete = "off"> <br>

<label> Password: </label> <br>
<input type = 'password' name = 'password' placeholder = 'Password' class = 'form-control' required title = 'Password'> <br>

<input type = 'submit' name = 'submit' value = 'Login' class = 'btn btn-default'> <br> <br>
