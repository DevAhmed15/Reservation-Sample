...
<form class = "form-horizontal" action = "edit_staff.php" method = "POST">
...
$sql = "update brokers set staff_id = '$fn' , password = '$pa' where id = '$IDD'";
...
echo "<script> 
alert('Error occurred during updating Member data, try again.');
window.location.href='users.php';
 </script>";
