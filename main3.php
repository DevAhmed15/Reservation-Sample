...
<a href="requests.php" style="padding-left:700px;"><img src="1.png" style="width:80px;height: 80px;" alt="Requests" /></a>
<a href="msgs.php" style="padding-left: 50px;"><img src="mail.png" style="width:80px;height: 80px;" alt="FeedBacks" /></a>
</div>
<div class="top-nav">
...
echo "<h4>WELCOME Admin NO: " . $id . "</h4>";

?>
<br>
<label> <p> <a href = "inbox.php" style="color:blue;"> Check Inbox </a> </p> </label>
