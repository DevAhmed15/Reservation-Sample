...
<form class = "form-horizontal" action = "add_staff.php" method = "POST">

<label> Staff_id </label> <br>
<input type = "text" name = "Sid" autocomplete = "off" class = "form-control" required title = "First Name"> <br>
...
$sql = "insert into brokers values(
'','$sid','$pass','$role')";
