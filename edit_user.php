...
$id             = @$_POST['db_id'];
$db_source      = strip_tags(@$_POST['db_source']);
$db_destination = strip_tags(@$_POST['db_destination']);
...
<input type = "text" name="fn" autocomplete = "off" class = "form-control" value = "<?php echo "$db_source" ?>" requierd > <br>

<label> Last Name : </label> <br>
<input type = "text" name="ln" autocomplete = "off" class = "form-control" value = "<?php echo "$db_destination" ?>" required > <br>

<label> Email : </label> <br>
<input type = "text" name="em" class ="form-control" value = "<?php echo "$db_flightno" ?>" required> <br>

<label> Password : </label> <br>
<input type = "text" name = "pas" class = "form-control" value = "<?php echo "$db_flightdate" ?>" required> <br>
...
$sql = "update customers set fname = '$fn' , lname = '$ln' , email = '$em' , password = '$pa' where id = '$IDD'";
$query = mysql_query($sql);

if($query)
{
echo "<script> 
alert('Customer data has been updated successfully.');
window.location.href='users.php';
 </script>";
}
else
echo "<script> 
alert('Error occurred during updating Customer data, try again.');
window.location.href='users.php';
 </script>";
