...
echo "<h3> Welcome : " . $db_fname ."  " . $db_lname ."</h3><br>";
}	
}

?>
<h2><a href="change_pass.php" style="color:blue;"> Edit Account </a></h2>

<h2><a href="reqMine.php" style="color:blue;"> My Requests </a></h2>
<br><br>
