...
<p> Please type your email address and password: </p> <br> 


<form class = "form-horizontal" action = "login.php" method = "POST">

<label> Email Address:</label> <br>
<input type = "email" class = "form-control" name = "email" autocomplete = "off" placeholder = "Email Address"> <br>
